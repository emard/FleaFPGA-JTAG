...
char *FleaFPGA_Desc[] = 
{
	...
	"ULX3S FPGA 12K v3.0.3",
	"ULX3S FPGA 25K v3.0.3",
	"ULX3S FPGA 45K v3.0.3",
	"ULX3S FPGA 85K v3.0.3",
	"ULX3S FPGA 12K v3.0.7",
	"ULX3S FPGA 25K v3.0.7",
	"ULX3S FPGA 45K v3.0.7",
	"ULX3S FPGA 85K v3.0.7",
};
...
int32_t FleaFPGA_Mode[] =
{
	...
	JTAG_FTDI_BITBANG_CBUS_READ,
	JTAG_FTDI_CBUS,
	JTAG_FTDI_BITBANG2, // FER ULX2S board JTAG / UART
	JTAG_FTDI_BITBANG, // ULX3S FPGA v1.7
	JTAG_FTDI_BITBANG, // ULX3S FPGA 25K v1.7
	JTAG_FTDI_BITBANG, // ULX3S FPGA 45K v1.7
	JTAG_FTDI_BITBANG, // ULX3S FPGA 12K v2.1.2
	JTAG_FTDI_BITBANG, // ULX3S FPGA 25K v2.1.2
	JTAG_FTDI_BITBANG, // ULX3S FPGA 45K v2.1.2
	JTAG_FTDI_BITBANG, // ULX3S FPGA 85K v2.1.2
	JTAG_FTDI_BITBANG, // ULX3S FPGA 12K v3.0.3
	JTAG_FTDI_BITBANG, // ULX3S FPGA 25K v3.0.3
	JTAG_FTDI_BITBANG, // ULX3S FPGA 45K v3.0.3
	JTAG_FTDI_BITBANG, // ULX3S FPGA 85K v3.0.3
	JTAG_FTDI_BITBANG, // ULX3S FPGA 12K v3.0.7
	JTAG_FTDI_BITBANG, // ULX3S FPGA 25K v3.0.7
	JTAG_FTDI_BITBANG, // ULX3S FPGA 45K v3.0.7
	JTAG_FTDI_BITBANG, // ULX3S FPGA 85K v3.0.7
};
...
int16_t FleaFPGA_ProductID[] =
{
	...
	0x6015,
	0x6015,
	0x6001, // FER ULX2S board JTAG / UART
	0x6015, // ULX3S FPGA v1.7
	0x6015, // ULX3S FPGA 25K v1.7
	0x6015, // ULX3S FPGA 45K v1.7
	0x6015, // ULX3S FPGA 12K v2.1.2
	0x6015, // ULX3S FPGA 25K v2.1.2
	0x6015, // ULX3S FPGA 45K v2.1.2
	0x6015, // ULX3S FPGA 85K v2.1.2
	0x6015, // ULX3S FPGA 12K v3.0.3
	0x6015, // ULX3S FPGA 25K v3.0.3
	0x6015, // ULX3S FPGA 45K v3.0.3
	0x6015, // ULX3S FPGA 85K v3.0.3
	0x6015, // ULX3S FPGA 12K v3.0.7
	0x6015, // ULX3S FPGA 25K v3.0.7
	0x6015, // ULX3S FPGA 45K v3.0.7
	0x6015, // ULX3S FPGA 85K v3.0.7
};
